...
def solnMC(input_file, mesh, mesh_fuel, dir_output):
    ...
    data_tot_J = np.array([np.zeros(len(mesh)), np.zeros(len(mesh))])
    data_tot_TL = np.array([np.zeros(len(mesh)), np.zeros(len(mesh))])
    data_tot_Phi = np.array([np.zeros(len(mesh)), np.zeros(len(mesh))])
    data_tot_Fi_t = np.array([np.zeros(len(mesh)), np.zeros(len(mesh))])
    data_tot_ms_birth = np.array([np.zeros(len(mesh)), np.zeros(len(mesh))])
    ...
    for g in range(num_gen):
        ...
        data_gen_TL = np.array([np.zeros(len(mesh)), np.zeros(len(mesh))])
        data_gen_J = np.array([np.zeros(len(mesh)), np.zeros(len(mesh))])
        data_gen_Phi = np.array([np.zeros(len(mesh)), np.zeros(len(mesh))])
        data_gen_Fi_t = np.array([np.zeros(len(mesh)), np.zeros(len(mesh))])
        data_gen_ms_birth = np.array([np.zeros(len(mesh))])
